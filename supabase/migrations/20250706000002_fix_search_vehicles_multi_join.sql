...
comment on function search_vehicles_multi is 'Recherche multi-champs dans les véhicules avec filtres et pagination. Recherche dans référence, marque et modèle. Jointure corrigée avec advertisements.car_id.'; 